...
const zhExact: Record<string, string> = {
  ...
  "year": "年",
  "Total cost NPV": "总成本现值",
  "Not available": "不可用",
  "Present value of tuition and living costs, using 5% annual tuition escalation, 3.5% annual living-cost escalation, and a 7% real opportunity cost rate.": "学费和生活费的现值，使用 5% 年度学费上涨、3.5% 年度生活费上涨，以及 7% 实际机会成本率。",
  "Payback uses discounted annual free cash flow against the present value of study costs.": "回本时间使用折现后的年度自由现金流，对比学习成本现值。",
  "Calculated as total cost divided by annual salary difference multiplied by QILT full-time employment rate.": "按总成本除以年度薪资差额与 QILT 全职就业率的乘积计算。",
  ...
  "Future cash flows are discounted at": "未来现金流折现率为",
  "Discounted cumulative employed free cash flow. Salary rises linearly to occupation median salary by year 5.": "折现后的就业情景累计自由现金流；收入在第 5 年线性达到职业中位薪资。",
  "Present value after 5% annual tuition escalation and 7% real discounting.": "按 5% 年度学费上涨并以 7% 实际折现率计算后的现值。",
  "Present value of tuition and study-period living costs.": "学费和学习期间生活费的现值。",
  "Salary-premium NPV compared with cost NPV.": "薪资溢价现值与成本现值的比较。",
  "Discounted at": "折现率为",
  "real opportunity cost": "实际机会成本",
  "Each scenario uses the configured NPV model: 7% real opportunity cost, 5% tuition escalation, 3.5% living-cost escalation, and 30 years of salary benefit. These are sensitivity tests, not forecasts.": "每个情景都使用配置好的 NPV 模型：7% 实际机会成本、5% 学费上涨、3.5% 生活费上涨，以及 30 年薪资收益。这些是敏感性测试，不是预测。",

...
const zhExact: Record<string, string> = {
  ...
  "Estimate education ROI": "估算教育投资回报",
  ...
  "Tuition compounded to graduation at the 10% annual model rate.": "学费按 10% 年化模型收益率复利计算到毕业时点。",
  "Tuition compounded to the graduation-date starting balance at the 10% annual model rate.": "学费先按 10% 年化模型收益率复利计算为毕业时点的起始成本余额。",
  "Includes tuition and study-period living costs compounded to graduation. Opportunity cost is excluded.": "包含按复利计算到毕业时点的学费和学习期间生活费；不包含机会成本。",
  "Graduation-date starting balance. During payback, this balance keeps compounding at 10% until recovered.": "这是毕业时点的起始成本余额；在回本期间，这笔余额会继续按 10% 复利增长，直到被自由现金流覆盖。",
  "Tuition and study-period living costs are compounded to graduation using the 10% annual return model. Opportunity cost is not included.": "学费和学习期间生活费会按 10% 年化回报模型复利计算到毕业时点；目前不计算机会成本。",
  "This is the graduation-date starting balance from tuition and study-period living costs. Payback keeps this balance compounding at 10% until recovered.": "这是由学费和学习期间生活费形成的毕业时点起始成本余额；回本计算会让这笔余额继续按 10% 复利增长，直到被覆盖。",
  "Payback uses invested post-graduation free cash flow, compounded annually at the same 10% model rate.": "回本时间使用毕业后的自由现金流，并按同样 10% 年化模型收益率进行复利累积。",
  "During payback, the study-cost balance keeps compounding at 10% each year, and annual free cash flow is used to reduce it.": "在回本期间，学习成本余额每年继续按 10% 复利增长，并用每年的自由现金流去抵扣。",
  "The study-cost balance keeps growing at 10% until free cash flow clears it.": "学习成本余额会继续按 10% 增长，直到自由现金流将其覆盖。",
  "Cumulative employed free cash flow invested at the 10% annual model rate. Salary rises linearly to occupation median salary by year 5.": "就业情景下的累计自由现金流按 10% 年化模型收益率复利累积；收入在第 5 年线性达到职业中位薪资。",
  "Each scenario starts from the graduate salary input and rises linearly to the mapped occupation median salary by year 5. Study costs and saved free cash flow use the 10% annual return model. These are sensitivity tests, not forecasts.": "每个情景都从毕业生薪资输入开始，并在第 5 年线性达到映射的职业中位薪资。学习成本和存下来的自由现金流都使用 10% 年化回报模型。这些是敏感性测试，不是预测。",
  "Each scenario starts from the graduate salary input and rises linearly to the mapped occupation median salary by year 5. During payback, the study-cost balance keeps compounding at 10% until free cash flow clears it. These are sensitivity tests, not forecasts.": "每个情景都从毕业生薪资输入开始，并在第 5 年线性达到映射的职业中位薪资。在回本期间，学习成本余额会继续按 10% 复利增长，直到自由现金流将其覆盖。这些是敏感性测试，不是预测。",
  ...
  "This check lists the salary input status for every pathway and flags duplicate salary defaults. Missing rows require a user-entered salary before ROI income and payback outputs are meaningful.": "此检查列出每条路径的薪资输入状态，并标记重复的薪资默认值。缺失行需要用户先输入薪资，ROI 收入和回本结果才有意义。",
